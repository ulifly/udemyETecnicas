// you will develop a function named decode(message_file). 
// This function should read an encoded message from a .txt file 
// and return its decoded version as a string.
...
// The key to decoding the message is to use the words corresponding 
// to the numbers at the end of each pyramid line (in this example, 1, 3, and 6). 
